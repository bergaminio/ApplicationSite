...
export const ui = {
  ...
  gradesZip:      { de: 'Alle Unterlagen als ZIP ↓', en: 'All documents as ZIP ↓' },
  gradesZipLaeuft: { de: 'Archiv wird gepackt...', en: 'Packing archive...' },
  gradesZipFehler: { de: 'Das Archiv konnte nicht erstellt werden.', en: 'The archive could not be created.' },
